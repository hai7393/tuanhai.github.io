...
import { removeMovieSeen } from '../../../store/slices/movie';
const TopRated = ({ id, title, backdrop_path }) => {
    ...
    const handleDelete = (id) => {
        dispatch(removeMovieSeen({id:id}))
        setVisible(false);
    };
    const showDialog = () => {
        setVisible(true);
        ...
        >
            <View>
                <Dialog.Container visible={visible} >
                    <Dialog.Title>Xoá danh sách đã xem</Dialog.Title>
                    <Dialog.Description>
                        Bạn có muốn xoá danh sách đã xem?.
                    </Dialog.Description>
